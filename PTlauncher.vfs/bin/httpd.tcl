...
set libhome [string trimright $home "/bin"]
...
if {[file exist [file join $libhome ../lib/httpd.tcl]]} {
    # Cases 1 and 2
    set Config(lib) [file join $libhome ../lib]
} elseif {[file exist [file join $libhome ../lib/tclhttpd$v]]} {
