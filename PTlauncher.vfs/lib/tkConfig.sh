...
TK_LIBS='-lX11 -lXss -lXext -L/home/sbron/root/cross-compilers/armv6-hardfloat-linux-gnueabi/armv6-hardfloat-linux-gnueabi/usr/lib/arm-linux-gnueabihf -lXft  -lfontconfig   -lpthread -ldl -lz   -lpthread -lieee -lm'

# Top-level directory in which Tk's platform-independent files are
# installed.
TK_PREFIX='/home/sbron/src/kitcreator/tk/inst'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/sbron/src/kitcreator/tk/inst'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/sbron/src/kitcreator/tk/build/tk8.6.3/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/sbron/src/kitcreator/tk/inst/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/sbron/src/kitcreator/tk/inst/include'
...
# compiled.
TK_SRC_DIR='/home/sbron/src/kitcreator/tk/build/tk8.6.3'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/sbron/src/kitcreator/tk/build/tk8.6.3/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/sbron/src/kitcreator/tk/inst/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/sbron/src/kitcreator/tk/build/tk8.6.3/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/sbron/src/kitcreator/tk/inst/lib/libtkstub8.6.a'
